class OccupationsController < ApplicationController
  ...
  before_action :verify_priority, only: [:create, :update, :index]
  ...
  def create
    ...
    respond_to do |format|
      if @occupation.save
        format.html { redirect_to @occupation, notice: 'Ocupación creada correctamente.' }
  ...
  def update
    respond_to do |format|
      if @occupation.update(occupation_params)
        format.html { redirect_to @occupation, notice: 'Ocupación actualizada correctamente.' }
  ...
  def destroy
    @occupation.destroy
    respond_to do |format|
      format.html { redirect_to occupations_url, notice: 'Ocupación eliminada correctamente.' }
